...
module Entity
    ...
    mutable struct Instance{P}
        ...
        function Instance{P}(hll::HllSets.HllSet{P}; grad=0.0, op=nothing) where {P}
    ...
    #------------------------------------------------------------
    # Set of Instance operations to support Static Instance Structure
    #------------------------------------------------------------
    ...
    #------------------------------------------------------------
    # Set of Instance operations to support Dynamic Instance Structure
    #------------------------------------------------------------
    """
    ...
    # function backprop!(instance::Instance{P}, instance_op::Operation{FuncType, ArgTypes}) where {P, FuncType<:typeof(diff), ArgTypes}
    #     if (instance.op != nothing) && (instance.op === instance_op) && (instance_op.op === diff)
    #         backprop!(instance, Operation(deleted, instance_op.args))
    #         backprop!(instance, Operation(retained, instance_op.args))
    #         backprop!(instance, Operation(added, instance_op.args))
    #     else
    #         println("Error: Operation not supported for terminal node")
    #     end
    # end
